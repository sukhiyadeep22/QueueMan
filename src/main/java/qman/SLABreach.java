...
public class SLABreach {
    ...
    public ModelAndView Queue(HttpServletRequest request) {
        ...
        try {
            String PyComm = "python /usr/local/tomcat7/webapps/ROOT/resources/python/tickets.py " + creationService.FetchToken((String)request.getSession().getAttribute("UserSessionName")).trim();
